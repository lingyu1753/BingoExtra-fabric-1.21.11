...
public class StructureCompassRenderUtils {
	...
	public static void drawConfiguredStringOnHUD(GuiGraphics guiGraphics, String string, int xOffset, int yOffset, int color, int relLineOffset) {
		yOffset += (relLineOffset + StructureCompassConfig.overlayLineOffset) * 9;
		if (StructureCompassConfig.structureCompassOverlaySide == StructureCompassOverlaySide.LEFT) {
