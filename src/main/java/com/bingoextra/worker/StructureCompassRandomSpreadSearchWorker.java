...
public class StructureCompassRandomSpreadSearchWorker extends StructureSearchWorker<RandomSpreadStructurePlacement> {
	...
	public StructureCompassRandomSpreadSearchWorker(ServerLevel level, Player player, ItemStack stack, BlockPos startPos, List<BlockPos> prevPos, RandomSpreadStructurePlacement placement, List<Structure> structureSet, Identifier structureOrGroupId, boolean isGroup, String managerId) {
	...
	protected String getName() {
		return "StructureCompassRandomSpreadSearchWorker";
	}
