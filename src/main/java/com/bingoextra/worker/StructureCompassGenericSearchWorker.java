...
public class StructureCompassGenericSearchWorker extends StructureSearchWorker<StructurePlacement> {
	...
	public StructureCompassGenericSearchWorker(ServerLevel level, Player player, ItemStack stack, BlockPos startPos, List<BlockPos> prevPos, StructurePlacement placement, List<Structure> structureSet, Identifier structureOrGroupId, boolean isGroup, String managerId) {
	...
	protected String getName() {
		return "StructureCompassGenericSearchWorker";
	}
