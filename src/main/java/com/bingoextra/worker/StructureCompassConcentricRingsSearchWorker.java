...
public class StructureCompassConcentricRingsSearchWorker extends StructureSearchWorker<ConcentricRingsStructurePlacement> {
	...
	public StructureCompassConcentricRingsSearchWorker(ServerLevel level, Player player, ItemStack stack, BlockPos startPos, List<BlockPos> prevPos, ConcentricRingsStructurePlacement placement, List<Structure> structureSet, Identifier structureOrGroupId, boolean isGroup, String managerId) {
	...
	public boolean hasWork() {
		...
		return !finished && prevPos.size() <= StructureCompassConfig.maxNextSearches && samples < StructureCompassConfig.maxSamples && chunkIndex < potentialChunks.size();
	}
	...
	protected String getName() {
		return "StructureCompassConcentricRingsSearchWorker";
	}
